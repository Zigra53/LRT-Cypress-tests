// LRT naujienos: tikrinama Mediatekos Naujienų srauto juosta

import '../ignore-errors-silence-log.cy.js'
import { SetMyTestingServer } from '../set-my-testing-server.cy.js'

let MyResultsFile = './mediatekos-naujienu-juosta.txt'

describe('LRT naujienos: tikrinama Mediatekos Naujienų srauto juosta', () => 
{
  it('Naujienų juosta', () => 
{
...
cy.visit(MyTestingServer + '/mediateka/irasas/2000263795/sveikinimu-koncertas')
