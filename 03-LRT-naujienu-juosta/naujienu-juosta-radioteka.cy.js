// naujienu-juosta.js created with Cypress

import '../ignore-errors-silence-log.cy.js'
import { SetMyTestingServer } from '../set-my-testing-server.cy.js'
let MyResultsFile = './radiotekos-naujienu-juosta.txt'

describe('LRT naujienos: tikrinama Naujienų srauto juosta', () => 
{
  it('Naujienų juosta', () => 
{
...
cy.visit(MyTestingServer + '/mediateka/irasas/2000263921/lietuvos-diena-lietuvos-banko-vadovas-palukanu-normos-dar-dides') 
